/* Utilized from https://dzenanhamzic.com/2016/09/21/java-mapreduce-for-top-n-twitter-hashtags/
  ...
  Example: hadoop jar TweetCount.jar TweetCount /user/hduser/users/twitter/tweets.txt /user/hduser/users/twitter/TweetOut
*/
    ...
    public static class TokenizerMapper extends
        ...
        public void map(Object key, Text value, Context context)
                ...
                while (itr.hasMoreTokens()) {
                    ...
                    if (token.startsWith("2009") || token.startsWith("2008")) {
                        word.set(token);
